...
from sqlalchemy import Integer, Float, Date, ForeignKey, Text, String, UniqueConstraint
...
class Goal(Base):
    ...
    target_amount_inr: Mapped[int] = mapped_column(Integer, nullable=False)  # paise
