...
from sqlalchemy import String, Integer, Float, Date, ForeignKey, Text, Enum as SAEnum, UniqueConstraint, Index
...
class Transaction(Base):
    ...
    charges_inr: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
